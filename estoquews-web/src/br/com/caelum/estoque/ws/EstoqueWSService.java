 ...
 * 2021-03-18T14:25:43.846-03:00
 * Generated source version: 2.7.13
 * 
 */
@WebServiceClient(name = "EstoqueWSService", 
                  wsdlLocation = "file:/D:/rodrigo/git_repo/CURSO_JAX_WS/estoquews-web/src/EstoqueWSServiceCap5.wsdl",
...
public class EstoqueWSService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/rodrigo/git_repo/CURSO_JAX_WS/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EstoqueWSService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/rodrigo/git_repo/CURSO_JAX_WS/estoquews-web/src/EstoqueWSServiceCap5.wsdl");
        }
        WSDL_LOCATION = url;
    }
